...
<head>
    ...
    <link rel="shortcut icon" href="{$view_admin_assets}/img/favicon.ico">

    <!-- global stylesheets -->
    <link rel="stylesheet" href="{$view_admin_assets}/css/bootstrap.min.css">
    <link rel="stylesheet" href="{$view_admin_assets}/font-awesome-4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="{$view_admin_assets}/css/font-icon-style.css">
    <link rel="stylesheet" href="{$view_admin_assets}/css/style.default.css" id="theme-stylesheet">

    <!-- Core stylesheets -->
    <link rel="stylesheet" href="{$view_admin_assets}/css/ui-elements/card.css">
    <link rel="stylesheet" href="{$view_admin_assets}/css/style.css">
</head>
    ...
    <nav class="navbar navbar-expand-lg ">
        ...
        <div class="container-fluid ">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
                <div class="navbar-header">
                    <a href="index.html" class="navbar-brand">
                        <div class="brand-text brand-big hidden-lg-down"><img src="{$view_admin_assets}/img/logo-white.png" alt="Logo" class="img-fluid"></div>
                        <div class="brand-text brand-small"><img src="{$view_admin_assets}/img/logo-icon.png" alt="Logo" class="img-fluid"></div>
                    </a>
            ...
            <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                <!-- Expand-->
                <li class="nav-item d-flex align-items-center full_scr_exp"><a class="nav-link" href="#"><img src="{$view_admin_assets}/img/expand.png" onclick="toggleFullScreen(document.body)" class="img-fluid" alt="></a></li>
                <!-- Search-->
                    ...
                    <ul aria-labelledby="messages" class="dropdown-menu">
                        <li>
                            <a rel="nofollow" href="#" class="dropdown-item d-flex">
                                <div class="msg-profile"> <img src="{$view_admin_assets}/img/avatar-1.jpg" alt="..." class="img-fluid rounded-circle"></div>
                                <div class="msg-body">
                        ...
                        <li>
                            <a rel="nofollow" href="#" class="dropdown-item d-flex">
                                <div class="msg-profile"> <img src="{$view_admin_assets}/img/avatar-2.jpg" alt="..." class="img-fluid rounded-circle"></div>
                                <div class="msg-body">
                        ...
                        <li>
                            <a rel="nofollow" href="#" class="dropdown-item d-flex">
                                <div class="msg-profile"> <img src="{$view_admin_assets}/img/avatar-3.jpg" alt="..." class="img-fluid rounded-circle"></div>
                                <div class="msg-body">
                ...
                <li class="nav-item dropdown"><a id="profile" class="nav-link logout" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{$view_admin_assets}/img/avatar-1.jpg" alt="..." class="img-fluid rounded-circle" style="height: 30px; width: 30px;"></a>
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="border border-primary">
                                                <a rel="nofollow " href="#" class=" d-flex">
                                                    <div class="news-f-img"> <img src="{$view_admin_assets}/img/avatar-2.jpg" alt="..." class="img-fluid rounded-circle"></div>
                                                    <div class="msg-body">
                                            ...
                                            <li class="border border-success">
                                                <a rel="nofollow" href="#" class=" d-flex">
                                                    <div class="news-f-img"> <img src="{$view_admin_assets}/img/avatar-3.jpg" alt="..." class="img-fluid rounded-circle"></div>
                                                    <div class="msg-body">
                                            ...
                                            <li class="border border-info">
                                                <a rel="nofollow" href="#" class=" d-flex">
                                                    <div class="news-f-img"> <img src="{$view_admin_assets}/img/avatar-4.jpg" alt="..." class="img-fluid rounded-circle"></div>
                                                    <div class="msg-body">
                                            ...
                                            <li class="border border-primary">
                                                <a rel="nofollow" href="#" class=" d-flex">
                                                    <div class="news-f-img"> <img src="{$view_admin_assets}/img/avatar-1.jpg" alt="..." class="img-fluid rounded-circle"></div>
                                                    <div class="msg-body">
                                                        <h6 class="h5 msg-nav-h6">Low cost Modern printer</h6>
                                                        <small>A dot matrix printer modified at...</small>
                                                    </div>
...
<div class="page-content d-flex align-items-stretch">
    ...
    <nav class="side-navbar">
        <div class="sidebar-header d-flex align-items-center">
            <div class="avatar"><img src="{$view_admin_assets}/img/avatar-1.jpg" alt="..." class="img-fluid rounded-circle"></div>
            <div class="title">
...
<!--Global Javascript -->
<script src="{$view_admin_assets}/js/jquery.min.js"></script>
<script src="{$view_admin_assets}/js/popper/popper.min.js"></script>
<script src="{$view_admin_assets}/js/tether.min.js"></script>
<script src="{$view_admin_assets}/js/bootstrap.min.js"></script>
<script src="{$view_admin_assets}/js/jquery.cookie.js"></script>
<script src="{$view_admin_assets}/js/jquery.validate.min.js"></script>
<script src="{$view_admin_assets}/js/chart.min.js"></script>
<script src="{$view_admin_assets}/js/front.js"></script>

<!--Core Javascript -->
<script src="{$view_admin_assets}/js/mychart.js"></script>
</body>

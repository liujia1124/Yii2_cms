...
<!-- Global styles BEGIN -->
<link href="{$view_home_assets}/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">
<link href="{$view_home_assets}/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet">
<!-- Global styles END -->
<!-- Page level plugin styles BEGIN -->
<link href="{$view_home_assets}/pages/css/animate.css" rel="stylesheet">
<link href="{$view_home_assets}/plugins/fancybox/source/jquery.fancybox.css" rel="stylesheet">
<!-- Page level plugin styles END -->
<!-- Theme styles BEGIN -->
<link href="{$view_home_assets}/pages/css/components.css" rel="stylesheet">
<link href="{$view_home_assets}/pages/css/slider.css" rel="stylesheet">
<link href="{$view_home_assets}/onepage/css/style.css" rel="stylesheet">
<link href="{$view_home_assets}/onepage/css/style-responsive.css" rel="stylesheet">
<link href="{$view_home_assets}/onepage/css/themes/red.css" rel="stylesheet" id="style-color">
<link href="{$view_home_assets}/onepage/css/custom.css" rel="stylesheet">
<!-- Theme styles END -->
</head>
...
<body class="menu-always-on-top">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-2 col-sm-2">
                    <a class="scroll site-logo" href="#promo-block"><img src="{$view_home_assets}/onepage/img/logo/free.png" width="100px;"  alt=""></a>
                </div>
                <!-- Logo END -->
        ...
        <div id="carousel-example-generic" class="carousel slide carousel-slider" style="margin-top: 60px;">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item carousel-item-two">
                    ...
                    <img class="carousel-position-two hidden-sm hidden-xs animate-delay" src="{$view_home_assets}/onepage/img/slider/Slide2_iphone_left.png" alt="Iphone" data-animation="animated fadeInUp">
                    <img class="carousel-position-three hidden-sm hidden-xs animate-delay" src="{$view_home_assets}/onepage/img/slider/Slide2_iphone_right.png" alt="Iphone" data-animation="animated fadeInUp">
                </div>
    ...
    <div class="about-block content content-center" id="about">
        <div class="container">
            ...
            <div class="ab-trio">
                <img src="{$view_home_assets}/onepage/img/trio.png" alt="" class="img-responsive">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 item">
                    <img src="{$view_home_assets}/onepage/img/people/img6-large.jpg" alt="Marcus Doe" class="img-responsive">
                    <h3>Marcus Doe</h3>
                    <em>Founder</em>
                ...
                <div class="col-md-4 item">
                    <img src="{$view_home_assets}/onepage/img/people/img7-large.jpg" alt="Elena Taylor" class="img-responsive">
                    <h3>Elena Taylor</h3>
                    <em>Designer</em>
                    <p>Lorem ipsum dolor amet, tempor ut labore magna tempor dolore</p>
                    <div class="tb-socio">
                ...
                <div class="col-md-4 item">
                    <img src="{$view_home_assets}/onepage/img/people/img8-large.jpg" alt="Cris Nilson" class="img-responsive">
                    <h3>Cris Nilson</h3>
                    <em>Developer</em>
                    <p>Lorem ipsum dolor amet, tempor ut labore magna tempor dolore</p>
                    <div class="tb-socio">
    ...
    <div class="portfolio-block content content-center" id="portfolio">
        ...
        <div class="row">
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="{$view_home_assets}/onepage/img/portfolio/2.jpg" alt="NAME" class="img-responsive">
                <a href="{$view_home_assets}/onepage/img/portfolio/2.jpg" class="zoom valign-center">
                    <div class="valign-center-elem">
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="{$view_home_assets}/onepage/img/portfolio/6.jpg" alt="NAME" class="img-responsive">
                    <a href="{$view_home_assets}/onepage/img/portfolio/6.jpg" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="{$view_home_assets}/onepage/img/portfolio/8.jpg" alt="NAME" class="img-responsive">
                    <a href="{$view_home_assets}/onepage/img/portfolio/8.jpg" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="{$view_home_assets}/onepage/img/portfolio/3.jpg" alt="NAME" class="img-responsive">
                <a href="{$view_home_assets}/onepage/img/portfolio/3.jpg" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="{$view_home_assets}/onepage/img/portfolio/5.jpg" alt="NAME" class="img-responsive">
                <a href="{$view_home_assets}/onepage/img/portfolio/5.jpg" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="{$view_home_assets}/onepage/img/portfolio/4.jpg" alt="NAME" class="img-responsive">
                <a href="{$view_home_assets}/onepage/img/portfolio/4.jpg" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="{$view_home_assets}/onepage/img/portfolio/1.jpg" alt="NAME" class="img-responsive">
                <a href="{$view_home_assets}/onepage/img/portfolio/1.jpg" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="{$view_home_assets}/onepage/img/portfolio/10.jpg" alt="NAME" class="img-responsive">
                <a href="{$view_home_assets}/onepage/img/portfolio/10.jpg" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="{$view_home_assets}/onepage/img/portfolio/9.jpg" alt="NAME" class="img-responsive">
                <a href="{$view_home_assets}/onepage/img/portfolio/9.jpg" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="{$view_home_assets}/onepage/img/portfolio/7.jpg" alt="NAME" class="img-responsive">
                <a href="{$view_home_assets}/onepage/img/portfolio/7.jpg" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12 text-left">
                    <img src="{$view_home_assets}/onepage/img/choose-us.png" alt="Why to choose us" class="img-responsive">
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12 text-left">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-2 col-sm-3 col-xs-6">
                    <img src="{$view_home_assets}/onepage/img/partners/cisco.png" alt="cisco">
                </div>
                <div class="col-md-2 col-sm-3 col-xs-6">
                    <img src="{$view_home_assets}/onepage/img/partners/walmart.png" alt="walmart">
                </div>
                <div class="col-md-2 col-sm-3 col-xs-6">
                    <img src="{$view_home_assets}/onepage/img/partners/gamescast.png" alt="gamescast">
                </div>
                <div class="col-md-2 col-sm-3 col-xs-6">
                    <img src="{$view_home_assets}/onepage/img/partners/spinwokrx.png" alt="spinwokrx">
                </div>
                <div class="col-md-2 col-sm-3 col-xs-6">
                    <img src="{$view_home_assets}/onepage/img/partners/ngreen.png" alt="ngreen">
                </div>
                <div class="col-md-2 col-sm-3 col-xs-6">
                    <img src="{$view_home_assets}/onepage/img/partners/vimeo.png" alt="vimeo">
                </div>
            </div>
        </div>
    </div>
...
<!--[if lt IE 9]>
<script src="{$view_home_assets}/plugins/respond.min.js"></script>
<![endif]-->
<!-- Load JavaScripts at the bottom, because it will reduce page load time -->
<!-- Core plugins BEGIN (For ALL pages) -->
<script src="{$view_home_assets}/plugins/jquery.min.js" type="text/javascript"></script>
<script src="{$view_home_assets}/plugins/jquery-migrate.min.js" type="text/javascript"></script>
<script src="{$view_home_assets}/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<!-- Core plugins END (For ALL pages) -->
<!-- Core plugins BEGIN (required only for current page) -->
<script src="{$view_home_assets}/plugins/fancybox/source/jquery.fancybox.pack.js" type="text/javascript"></script><!-- pop up -->
<script src="{$view_home_assets}/plugins/jquery.easing.js"></script>
<script src="{$view_home_assets}/plugins/jquery.parallax.js"></script>
<script src="{$view_home_assets}/plugins/jquery.scrollTo.min.js"></script>
<script src="{$view_home_assets}/onepage/scripts/jquery.nav.js"></script>
<!-- Core plugins END (required only for current page) -->
<!-- Global js BEGIN -->
<script src="{$view_home_assets}/onepage/scripts/layout.js" type="text/javascript"></script>
<script src="{$view_home_assets}/pages/scripts/bs-carousel.js" type="text/javascript"></script>
<script>
